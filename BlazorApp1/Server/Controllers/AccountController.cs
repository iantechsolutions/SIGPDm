    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ResetPassword([FromBody] int id)
        {
            try
            {
                ...
                var user = db.Users.FirstOrDefault(x => x.UserName == employee.Email);
                if (user == null)
                {
                    return BadRequest("No se pudo encontrar un usuario de acceso");
                }
        ...
        {
            var employee = db.Employees.FirstOrDefault(x => x.Email == userInfo.UserName);
        ...
        private string BuildToken(string username)
        {
            ...
            {
                var employee = db.Employees.First(x => x.Email == user.UserName);
